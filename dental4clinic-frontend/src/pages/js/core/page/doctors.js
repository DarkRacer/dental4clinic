...
const doctorSelector = document.getElementById("getElementById");;
...
const doctorsDialog = document.getElementById('#doctorsDialog');
...
const initDoctors = () => {
  ...
  document.getElementById('#doctorsDialogClose').onclick = () => {
